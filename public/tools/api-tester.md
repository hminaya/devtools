...
Live tool: https://www.developers.do/tools/api-tester
Category: Networking

Free and browser-based, but not fully offline: input is sent from the browser to the API endpoint you enter. It is not sent to a developers.do server.
