...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/tools/json-to-swift',
  },
  openGraph: {
    url: 'https://www.developers.do/tools/json-to-swift',
    ...
    images: [{ url: '/og/tools/json-to-swift.png', width: 1200, height: 630, alt: 'JSON to Swift tool preview' }],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['/og/tools/json-to-swift.png'],
  },
};
