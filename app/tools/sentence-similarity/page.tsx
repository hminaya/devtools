...
export const metadata: Metadata = {
  ...
  keywords: 'sentence similarity, semantic similarity, cosine similarity, duplicate detection, semantic search, text matching, NLP, machine learning, vector similarity, transformers.js, all-MiniLM-L6-v2, free online tool, browser-based, no install required',
  openGraph: {
